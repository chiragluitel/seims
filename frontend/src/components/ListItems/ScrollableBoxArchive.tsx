...
const ScrollableBox: React.FC<ScrollableBoxProps> = ( {children} ) => {
    ...
    const handleScroll = () =>{
        ...
        const contentPage = currentPage > 0 ? currentPage - 1 : 0;
        setPage(contentPage);
    ...
    const handlePageClick = (page: number) => {
        setPage(page);
        if (scrollContainerRef.current){
            const scrollPosition = scrollContainerRef.current.clientWidth * (page + 1);
    ...
    return (
        ...
        <div className="relative">
            ...
            >
                <div className="w-1/2 flex-shrink-0 snap-start"></div> 
