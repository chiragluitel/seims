//Need to revise to add SignIn/SignUp Options
//Or is this even required? The app shouldn't be used without logging in. 
//There should be an entirely different screen for logged out users to log in.
